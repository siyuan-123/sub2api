...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/siyuan-123/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="siyuan-123/sub2api"
...
Documentation=https://github.com/siyuan-123/sub2api
